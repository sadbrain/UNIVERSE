...
(2, 'Chanel-MIAA Unisex Wide Leg Wide Leg High Waist Pocket Khaki Pants for Men and Women, Youthful Style khaki cargo pants for men and women', 1, 400000.00, 0, '#000', 'M', 2, 2),
...
(4, 'Chanel-SUKIYA GhiLe Women\'s Wool Sweater Smooth Wool All Sizes Latest Model 2023 AL47', 1, 600000.00, 0, '#000', 'L', 4, 4),
...
(6, 'Chanel-SET OF 3 SHIRT + TENNIS SKIRT + TIE', 1, 500000.00, 0, '#000', 'X', 6, 6),
(7, 'Chanel-SET GILE SWEATSHIRT + BLUE SKIRT + TIE', 1, 600000.00, 50.00, '#000', 'M', 7, 7),
(8, 'Chanel-SET OF 3 FLORAL GILE SHIRTS + SHIRT + SUPER KUTE TENNIS SKIRT', 1, 400000.00, 0, '#000', 'S', 8, 8),
(9, 'Chanel-RUICHE waistcoat+vest+women\'s vest set Popular INS cozy Elegant WCS24104RC 2Z24010', 1, 300000.00, 50.00, '#000', 'M', 9, 9),
(10, 'Chanel-Women\'s sweater vest with wide flaps to cover the shoulders, fashion style AO33', 1, 700000.00, 0, '#000', 'X', 10, 10),
...
(12, 'Chanel-Feminine office-style wide-leg fabric pants with bow tie, show off super pretty figure QU2', 1, 400000.00, 0, '#000', 'S', 12, 12),
(13, 'Prada-Berets, Korean style fashion berets', 1, 300000.00, 50.00, '#FF0033', 0, 13, 13),
(14, 'Prada-Vintage Korean style embossed Heart-shaped Beret Hat', 1, 600000.00, 0, '#FF0033', 0, 14, 14),
(15, 'Prada-Large head circumference Loose Knitted Wool Hat with Metal Label Coordinated Autumn and Winter Fashion Easy to Coordinate for Men and Women', 1, 800000.00, 50.00, '#FF0033', 0, 15, 15),
(16, 'Prada-Fashionable 40cm brim hat for women _high quality products at factory prices _free foam stickers.', 1, 900000.00, 0, '#FF0033', 0, 16, 16),
(17, 'Prada-Paint brand umbrella hats, high quality umbrellas, wholesale prices_painted hats', 1, 1000000.00, 50.00, '#FF0033', 0, 17, 17),
(18, 'Prada-Small Brim Hats (Lots of Money For What) Are Hot Now for Both Men and Women. Real pictures with video', 1, 900000.00, 0, '#FF0033', 0, 18, 18),
(19, 'Prada-HIGH QUALITY KAKI HAT_EMBROADED LOGO WITH BEAUTIFUL TEXTURES_IN STOCK PRICE', 1, 800000.00, 50.00, '#6600FF ', 0, 19, 19),
(20, 'Prada-HIGH QUALITY KAKI HAT_EMBROADED LOGO WITH BEAUTIFUL TEXTURES_IN STOCK PRICE', 1, 700000.00, 0, '#6600FF ', 0, 20, 20),
(21, 'Prada-Moc® New style warm winter wool hat, easy to coordinate with thick and smooth clothes HT-G-038', 1, 600000.00, 50.00, '#6600FF ', 0, 21, 21),
(22, 'Prada-Nbviesrt Baseball Cap Youthful Dynamic Design Hat for men and women American Retro Style', 1, 500000.00, 50.00, '#6600FF ', 0, 22, 22),
(23, 'Prada-New Korean Autumn and Winter Fashion Wool Brim Hat for Women', 1, 400000.00, 50.00, '#6600FF ', 0, 23, 23),
(24, 'Prada-Lucy\'s 3-striped high-end bucket hat P4-A3', 1, 700000.00, 25.00, '#6600FF ', 0, 24, 24),
